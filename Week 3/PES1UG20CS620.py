...
def get_avg_info_of_attribute(df, attribute):
    ...
    for attribute_value in unique_attribute_values:
        ...
        average_info_of_attribute = average_info_of_attribute + entropy_of_attribute_value*(total_count_in_an_instance/no_of_instances)
    return(abs(average_info_of_attribute))
